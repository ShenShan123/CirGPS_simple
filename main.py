...
if __name__ == "__main__":
    ...
    parser.add_argument("--add_tar_edge", type=int, default=0, help="Inject target edges into the graph.")
    ...
    parser.add_argument("--noise_sigma", type=float, default=0.01, help="The simga_noise of Balanced MSE (EQ 3.6).")
    ...
    parser.add_argument('--use_stats', type=int, default=0, help='Circuit statistics features.')
